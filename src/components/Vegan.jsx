...
function Vegan() {
  ...
  const getVegan = async () => {
    ...
    const item = localStorage.getItem("vegan")

    if (item) { // if a recipe is already in local storage
      setVegan(JSON.parse(item)) // display that item
    } else {
      ...
      localStorage.setItem("vegan", JSON.stringify(data.recipes))  // local storage has to be a string, therefore, 'stringify
